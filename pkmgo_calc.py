...
try:
    with open('PKMBase.csv', encoding='utf8') as cf:
...
def total_stardust_cost(file, verbose = True):
    ...
    if verbose:
        ...
        if tabulate_installed:
            ...
            print("use command: \"pip install tabulate\" or \"conda install tabulate\" to install tabulate package to get pretty prints")
